    ...
    public void run() {
        try {
            ...
            while(true) {
                ...
                field.canMove(this);
                //
                if((x+speedX >= Kirpizh.getX()) && (x+speedX <= Kirpizh.getWidth()+ Kirpizh.getX()) && (y+speedY <= Kirpizh.getY()))
                    if(y + speedY >= Kirpizh.getY()-radius){
                        // Достигли верхней плоскотси прямоугольника, отскакиваемся вверх
                        speedY = -speedY;
                        y = Kirpizh.getY()-radius;
                    }

                if((y + speedY >= Kirpizh.getY()) && (y+ speedY <= Kirpizh.getHeight()+ Kirpizh.getY()) && (x+speedX <= Kirpizh.getX()))
                    if((x + speedX>= Kirpizh.getX()-radius)){
                        // Достигли правой плоскотси прямоугольника, отскакиваемся влево
                        speedX = -speedX;
                        x = Kirpizh.getX()-radius;
                    }

                if((x+speedX >= Kirpizh.getX()) && (x+speedX <= Kirpizh.getWidth()+ Kirpizh.getX()) && (y+speedY >= Kirpizh.getY()+ Kirpizh.getHeight()))
                    if((y + speedY<= Kirpizh.getY()+ Kirpizh.getHeight()+radius)){
                        // Достигли нижней плоскотси прямоугольника, отскакиваемся вниз
                        speedY = -speedY;
                        y = Kirpizh.getY()+ Kirpizh.getHeight()+radius;
                    }

                if((y + speedY >= Kirpizh.getY()) && (y+ speedY <= Kirpizh.getHeight()+ Kirpizh.getY()) && x+speedX >= Kirpizh.getX()+ Kirpizh.getWidth())
                    if((x + speedX<= Kirpizh.getX()+ Kirpizh.getWidth()+radius)){
                        // Достигли левой плоскотси прямоугольника, отталкиваемся вправо
                        speedX = -speedX;
                        x = Kirpizh.getX()+ Kirpizh.getWidth()+radius;
                    }
                //
                if (x + speedX <= radius) {
